...
mvn archetype:generate 
   ...
   -DarchetypeVersion=7.8.1-SNAPSHOT
   -Dversion=7.8.1-SNAPSHOT
...
```
mvn archetype:generate -DarchetypeGroupId=org.jbpm -DarchetypeArtifactId=jbpm-workitems-archetype -DarchetypeVersion=7.8.1-SNAPSHOT -Dversion=7.8.1-SNAPSHOT -DgroupId=org.jbpm.contrib -DartifactId=myworkitem -DclassPrefix=MyWorkItem -DarchetypeCatalog=local
```
